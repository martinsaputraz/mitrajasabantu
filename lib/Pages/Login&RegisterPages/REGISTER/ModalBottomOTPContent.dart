...
class ModalBottomOTPContent extends StatefulWidget {
  ...
  @override
  ModalBottomOTPContentState createState() => ModalBottomOTPContentState();
}

class ModalBottomOTPContentState extends State<ModalBottomOTPContent> {
                ...
                Row(
                  children: [
                    ...
                    Text(
                      'OTP dikirim ke SMS',
                      style:
                          TextStyle(color: assetsColor.textOtpMethodOptButton),
                    ),
                  ],
                ),
                Icon(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    'Kirim kode OTP',
                    style: TextStyle(
                        color: assetsColor.textSentOTPCodeButton, fontSize: 18),
                  ),
                ],
              ),
            ),
